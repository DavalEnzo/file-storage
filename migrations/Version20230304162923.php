...
final class Version20230304162923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE files (id INT AUTO_INCREMENT NOT NULL, storage_id INT NOT NULL, name VARCHAR(255) NOT NULL, format VARCHAR(45) NOT NULL, size NUMERIC(7, 2) NOT NULL, upload_date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX IDX_63540595CC5DB90 (storage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE storage (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, initial_capacity INT NOT NULL, left_capacity INT NOT NULL, UNIQUE INDEX UNIQ_547A1B34A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE files ADD CONSTRAINT FK_63540595CC5DB90 FOREIGN KEY (storage_id) REFERENCES storage (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE files DROP FOREIGN KEY FK_63540595CC5DB90');
