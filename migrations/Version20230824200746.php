 ...
 */
final class Version20230824200746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE storage CHANGE initial_capacity initial_capacity INT DEFAULT 20000000000 NOT NULL, CHANGE left_capacity left_capacity INT DEFAULT 20000000000 NOT NULL');
    }
