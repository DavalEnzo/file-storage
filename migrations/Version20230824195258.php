 ...
 */
final class Version20230824195258 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE storage CHANGE initial_capacity initial_capacity INT DEFAULT 2000 NOT NULL, CHANGE left_capacity left_capacity INT DEFAULT 2000 NOT NULL');
